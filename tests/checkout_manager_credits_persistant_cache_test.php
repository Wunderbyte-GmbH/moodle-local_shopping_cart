 ...
 */
final class checkout_manager_credits_persistant_cache_test extends checkout_process_test_setup {
    /**
    ...
    public static function checkoutprocessdataprovider(): array {
        return [
            ...
            'User has no cerdits, does use it, inputs addresses and valid vatnumber, no cache deletion' => [
                [
                    'showvatnrchecker' => '1',
                    'owncountrycode' => 'DE',
                    'onlywithvatnrnumber' => '1',
