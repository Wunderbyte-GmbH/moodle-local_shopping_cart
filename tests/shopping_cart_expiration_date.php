...
require_once($CFG->dirroot . '/local/shopping_cart/tests/mocktime/time_mock.php');
 ...
 */
function time() {
    return \local_shopping_cart\\time_mock::get_mock_time() ?? 1000000000;
}
";
        ...
        foreach ($files as $file) {
            ...
            if (strpos($path, 'local_shopping_cart_local_time') > 0) {
                $a = 1;
            }
