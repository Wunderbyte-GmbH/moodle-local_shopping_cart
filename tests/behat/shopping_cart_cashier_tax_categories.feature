...
Feature: Cashier actions in shopping cart with tax categories enabled.
  ...
  Scenario: Cashier buys three items when tax categories eanbled
    ...
    Then I should see "Test item 1" in the "#shopping_cart-cashiers-section div.shopping-cart-items" "css_element"
    ...
    And I should see "Test item 2" in the "#shopping_cart-cashiers-section div.shopping-cart-items" "css_element"
    ...
    And I should see "Test item 3" in the "#shopping_cart-cashiers-section div.shopping-cart-items" "css_element"
