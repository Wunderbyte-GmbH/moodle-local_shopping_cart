...
Feature: Cashier actions in shopping cart with tax categories enabled.
  ...
  Scenario: Cashier buys three items when tax categories eanbled
    ...
    And I should see "11.5 EUR" in the "#shopping_cart-cashiers-section ul.shopping-cart-items #item-local_shopping_cart-main-1 .item-price" "css_element"
    And I should see "(10 EUR + 15%)" in the "#shopping_cart-cashiers-section ul.shopping-cart-items #item-local_shopping_cart-main-1 .item-price" "css_element"
    ...
    And I should see "(20.3 EUR + 10%)" in the "#shopping_cart-cashiers-section ul.shopping-cart-items #item-local_shopping_cart-main-2 .item-price" "css_element"
    ...
    ## And I should see "(20.3 EUR + 10%)" in the "ul.cashier-history-items div.item-price" "css_element"
    And I should see "my test item 3" in the "ul.cashier-history-items" "css_element"
    And I should see "13.8 EUR" in the "ul.cashier-history-items" "css_element"
    ## And I should see "(13.8 EUR + 0%)" in the "ul.cashier-history-items div.item-price" "css_element"