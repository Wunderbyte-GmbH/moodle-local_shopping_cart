...
Feature: Configure tax categories and use VAT and testing address UI.
  ...
  Scenario: Shopping Cart taxes: verify CRUD of address UI
    ...
    And I should see "(10.00 EUR + 15%)" in the ".checkoutgrid.checkout #item-local_shopping_cart-main-1 .item-price" "css_element"
    And I press "Edit selected address"
    And I set the field "Address" to "Commerco 100"
    And I press "Save address"
    And I should see "Commerco 100" in the ".local-shopping_cart-addressselection" "css_element"
    And I should not see "Brovarna 53" in the ".local-shopping_cart-addressselection" "css_element"
    ## Delete the selected address
    And I press "Delete selected address"
    And I press "Submit deletion"
    And I should not see "Lisboa" in the ".local-shopping_cart-addressselection" "css_element"
    And I should see "Wien" in the ".local-shopping_cart-addressselection" "css_element"
