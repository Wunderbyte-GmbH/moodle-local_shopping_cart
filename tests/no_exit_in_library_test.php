 ...
 * instead; only page scripts (checkout.php etc.) may legitimately exit.
 *
 * @package local_shopping_cart
 * @coversNothing
 */
final class no_exit_in_library_test extends basic_testcase {
    ...
    private const ALLOWED = [
        // Browser-only "no payment account" error page; PHPUnit/CLI/AJAX/WS throw before reaching it.
        'classes/shopping_cart_history.php' => 1,
    ];
    ...
    public function test_library_code_contains_no_exit_or_die(): void {
        ...
        $this->assertSame(
            ...
            . '(see shopping_cart_history::get_history_list_for_user for the pattern).'
        );
    }
}
