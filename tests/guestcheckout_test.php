...
final class guestcheckout_test extends advanced_testcase {
    ...
    public static function url_pattern_provider(): array {
        return [
            ...
            'catch-all matches front page' => ['/', '*', true],
            'catch-all matches front page script' => ['/index.php', '/*', true],
            'catch-all matches dashboard' => ['/my/', '*', true],
            'catch-all matches dashboard script' => ['/my/index.php', '/*', true],
            'catch-all matches activity page' => ['/mod/booking/view.php?id=5', '*', true],
            'catch-all matches any module' => ['/mod/page/view.php?id=6', '/*', true],
            'catch-all does not match course page' => ['/course/view.php?id=2', '*', false],
            'catch-all does not match user profile' => ['/user/profile.php?id=3', '/*', false],
            'catch-all does not match calendar' => ['/calendar/view.php', '*', false],
            'catch-all does not match checkout' => ['/local/shopping_cart/checkout.php', '/*', false],
            'catch-all does not match a path merely starting with my' => ['/mypage/index.php', '*', false],
            'catch-all does not match a path merely starting with mod' => ['/modules.php', '*', false],
            'explicit pattern still covers other areas' => ['/course/view.php?id=2', "*\n/course/*", true],
