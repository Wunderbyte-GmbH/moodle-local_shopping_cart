...
$string['addresses:edit:selected'] = 'Edit selected address';
$string['addresses:feedback'] = 'Please select the required addresses: {$a}';
...
$string['addresses:newaddress:updated'] = 'Address updated';
...
$string['addresses:saveaddress:submit'] = 'Save address';
$string['addresses:select'] = 'Select {$a}';
...
$string['addtocartitem'] = 'Add to cart: {$a}';
...
$string['allowcustombookingfee'] = 'Allow item-specific booking fee';
$string['allowcustombookingfee_desc'] = 'Items (e.g. booking options) can define their own booking fee in their settings form. It overrides the global and the costcenter-specific booking fee; empty means the global fee logic applies, 0 means explicitly no fee. With several items in the cart, the highest item-specific fee is charged.';
...
$string['applydiscountitem'] = 'Apply discount to {$a}';
...
$string['cachedef_cachedcouponstable'] = 'Coupon Cache';
...
$string['cartbadge'] = 'Cart badge (embeddable)';
$string['cartcheckout'] = 'Cart checkout (embeddable)';
$string['cartisempty'] = 'Your shopping cart is empty.';
$string['cartisfull'] = 'Your shopping cart is full.';
$string['cartitemcount'] = '{$a} item(s) in the shopping cart';
$string['cash'] = 'Cash';
...
$string['completeshoppingcartprecheckout'] = 'Before continuing with the payment process, submit the mandatory fields: ';
...
$string['confirmvatnumbervoluntarily'] = 'Confirm';
...
$string['costcenterstrings_desc'] = 'Translations for costcenters. One line per costcenter in this format: <br>costcenter1,Readable string for costcenter 1<br>costcenter2,Readable string for costcenter 2';
$string['countmode'] = 'Count usages per';
$string['countmode_help'] = 'Checkout: one checkout counts as one usage, no matter how many items in it were discounted. Item: every discounted item counts as one usage, so a checkout with four discounted items uses the coupon four times. Items the coupon does not apply to never count.';
$string['countmodecheckout'] = 'Checkout';
$string['countmodeitem'] = 'Item';
...
$string['couponcodeexists'] = 'A coupon with this code already exists.';
...
$string['couponmaxusesperuserreached'] = 'You have already used this coupon code the maximum number of times.';
$string['couponmaxusesreached'] = 'This coupon code has already been used the maximum number of times.';
...
$string['couponusedfororder'] = 'Coupon code "{$a}" was used for this order.';
...
$string['de'] = "Germany";
$string['decreaseamount'] = 'Decrease amount of {$a}';
...
$string['defaultcurrency'] = 'Default invoice currency';
$string['defaultcurrency_desc'] = 'Transaction currency for ERPNext invoices. EUR keeps the existing behaviour; other currencies are used when a caller injects one (e.g. USD from the marketplace).';
...
$string['deleteitem'] = 'Remove {$a} from the cart';
...
$string['el'] = "Greece";
$string['email'] = 'E-Mail';
$string['embedheading'] = 'Embedding (iframe)';
$string['embedheadingdescription'] = 'Settings for cart views (badge, checkout) shown in iframes on external websites through a seller plugin\'s embed endpoint.';
$string['embedredirectallowlist'] = 'Allowed redirect targets';
$string['embedredirectallowlist_desc'] = 'One URL prefix per line. When an embedded cart view carries a checkout or success redirect override, it is only honoured if it starts with one of these prefixes; otherwise the Moodle default is used. Leave empty to disallow all overrides. Example: https://www.example.com/';
...
$string['errorvatnrrequestlimit'] = 'VAT validation is temporarily unavailable because the request limit has been reached. Please try again in a few minutes.';
$string['errorvatnrserviceunavailable'] = 'VAT validation service is currently unavailable. Please try again later.';
$string['es'] = "Spain";
...
$string['invalidabsolute'] = 'The absolute discount cannot be negative.';
$string['invalidcountmode'] = 'Invalid counting mode for coupon usages.';
$string['invalidcouponcode'] = 'The coupon code you entered is invalid.';
$string['invalidmaxnumber'] = 'The maximum number of uses must not be negative. Enter 0 for unlimited.';
$string['invalidpercentage'] = 'Please enter a value between 0 and 100.';
...
$string['licenseheadingdescription'] = 'Some features of Shopping Cart, such as coupons, require a valid PRO license key.';
$string['licenseinvalid'] = 'License key is invalid.';
$string['licensekey'] = 'License key';
$string['licensekeydesc'] = 'Enter your Shopping Cart PRO license key here to activate PRO features such as coupons.';
$string['licensewrongproduct'] = 'This license key is not valid for Shopping Cart PRO.';
$string['lt'] = "Lithuania";
...
$string['maxnumber'] = 'Maximum number of uses';
$string['maxnumber_help'] = 'Maximum number of uses across all users. 0 means unlimited. Uses are counted from the ledger according to the counting mode.';
$string['maxnumberperuser'] = 'Maximum number of uses per user';
$string['maxnumberperuser_help'] = 'Maximum number of uses for a single user. 0 means unlimited. Uses are counted from the ledger according to the counting mode.';
$string['modifyreservationtimeitem'] = 'Change the reservation time of {$a}';
...
$string['noitemsaffected'] = 'No items are linked to this coupon.';
$string['noitemsincart'] = 'There are no items in the cart';
$string['nolimit'] = 'No limit';
$string['nomulticurrencysupportyet'] = 'Credits in more than one currency are not supported yet. Please contact the site administration.';
$string['noneu'] = "Non-European (outside the EU)";
...
$string['onlywithvatnrnumber'] = "VAT number is mandatory";
$string['onlywithvatnrnumber_desc'] = "Only allow booking if a valid VAT number is provided.";
$string['optioncancelled'] = 'Booking option cancelled';
$string['orderdetails'] = 'Order details';
$string['orderid'] = 'OrderID';
$string['owncountrycode'] = "Country of own company";
$string['owncountrycode_desc'] = "Choose the country where your own company is located.";
...
$string['ownvatnrnumber_desc'] = "Enter the VAT number of your own company.";
$string['paid'] = 'Paid';
$string['paidby'] = 'Paid by';
$string['paidby:americanexpress'] = 'American Express';
$string['paidby:applepay'] = 'Apple Pay';
$string['paidby:dinersclub'] = 'Diners Club';
$string['paidby:eps'] = 'EPS';
$string['paidby:googlepay'] = 'Google Pay';
...
$string['paymentconfirmed_desc'] = 'User with the userid {$a->userid} has successfully completed a payment with the identifier {$a->identifier} for the user with the id {$a->relateduserid}';
$string['paymentcredits'] = 'with credits';
$string['paymentdenied'] = 'Payment denied!';
$string['paymentfailed'] = 'Payment not successful';
$string['paymentfaileddescription'] = 'Something went wrong with your payment. Please try again.';
...
$string['paymentmethodpartialrefund'] = 'Partial refund';
$string['paymentmethodrebookingcreditscorrection'] = 'Credits via Rebooking';
...
[[date]], [[datetime]], [[invoice_number]] and [[order_number]] (outside of [[items]] tag).
...
$string['sch_bookingfee'] = 'Item-specific booking fee';
$string['sch_bookingfee_error'] = 'Enter a number greater than or equal to 0, or leave the field empty.';
$string['sch_bookingfee_help'] = 'Booking fee charged when this item is purchased. Leave empty to use the global booking fee settings. Enter 0 to charge no booking fee for this item. Note: If the booking fee is configured to be charged only once per user, users who already paid a booking fee will not be charged again.';
$string['sch_couponoptincodes'] = 'Opt-in coupons';
$string['sch_couponoptoutcodes'] = 'Opt-out coupons';
...
$string['schistorysections_desc'] = 'Use this setting to structure your shopping cart history
(Shortcode [shoppingcarthistory]) into collapsoible sections. Select a starting month and an interval.
Example: Starting month: March, Interval: semi-annually => ... 03/2025-08/2025, 09/2025-02/2026 ...<br>
<span class="text-danger">Note: After activation, you need to <b>save and reload this page</b> so you can
set starting month and interval.</span>';
$string['schistorysectionsinterval'] = 'Interval';
$string['schistorysectionsintervalannually'] = 'Annually';
...
$string['serviceperiod'] = 'Service period';
$string['serviceperiodend'] = 'End of service period';
$string['serviceperiodstart'] = 'Start of service period';
$string['shopping_cart:canbuy'] = 'Can buy';
$string['shopping_cart:cansearchusers'] = 'Can search other users';
$string['shopping_cart:canseecartnavitem'] = 'See shopping cart navigation item';
...
$string['shopping_cart:editcoupons'] = 'User has rights to manage coupons';
$string['shopping_cart:history'] = 'See History';
$string['shoppingcarthistory'] = 'All purchases of a given user';
$string['shortcode_warning_invalid_securitytoken'] = 'The shopping cart shortcode security token is invalid.';
$string['shortcode_warning_missing_securitytoken'] = 'This shopping cart shortcode requires a securitytoken parameter.';
$string['shortcodeschistorysettings'] = 'Shopping cart history settings';
$string['shortcodetoken'] = 'Shortcode security token';
$string['shortcodetoken_desc'] = 'Security token required for the embeddable cart shortcodes (cartbadge, cartcheckout). A random 8-character token is generated by default. Only shortcodes that pass the same token in the securitytoken parameter will render.';
$string['showcart'] = 'Show shopping cart';
$string['showcartwithcount'] = 'Show shopping cart, {$a} item(s)';
...
$string['showuseditems'] = "Show items that use that couppon code";
$string['showvatnrchecker'] = "Use VAT number";
$string['showvatnrcheckerdescription'] = "Activates input and verification of a VAT number before payment.";
$string['showwhereactive'] = 'Show where coupon can be used';
$string['si'] = "Slovenia";
$string['sk'] = "Slovakia";
...
$string['tocheckout'] = 'To checkout';
$string['tocheckoutitem'] = 'To checkout, {$a} is in the shopping cart';
$string['token'] = 'Token';
...
$string['vatnrnoneufeedback'] = 'Non-European selected — no VAT number check is performed.';
$string['vatnrvalidationfeedback'] = 'VAT number was successfully validated';
$string['vatnrverificationinprogress'] = 'Checking VAT number...';
$string['vatnumbervoluntarily'] = 'I have a valid VAT number.';
