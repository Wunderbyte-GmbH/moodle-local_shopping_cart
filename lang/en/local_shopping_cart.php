...
$string['selltoguests'] = 'Sell to guest users';
$string['selltoguests_desc'] = 'Guest users can buy items and will register on the plattform only on successful payment';
