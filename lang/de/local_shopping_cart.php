...
$string['pdfaenabled'] = 'PDF/A-2b-konforme PDFs erzeugen';
$string['pdfaenabled_desc'] = 'Buchungsbestätigungen / Rechnungen (Vorlagen unten) und das Tagessummen-PDF als PDF/A-2b (archivfähig) erzeugen: Alle Schriften werden eingebettet, Helvetica/Arial, Times und Courier in den Vorlagen werden auf die einbettbaren Schriften FreeSans, FreeSerif und FreeMono abgebildet, CMYK-Bilder werden nach RGB konvertiert. Per URL eingebundene Bilder lädt der Server (die cURL-Sicherheitseinstellungen von Moodle gelten); ein nicht ladbares Bild wird weggelassen, das PDF wird trotzdem erzeugt. Ist die Option deaktiviert, werden die PDFs exakt wie bisher erzeugt.';
$string['pdfahint'] = 'Ist „PDF/A-2b-konforme PDFs erzeugen“ aktiviert, wird diese Vorlage als PDF/A-2b gerendert: Verwenden Sie die Schriften FreeSans / FreeSerif / FreeMono (Helvetica, Arial → FreeSans; Times → FreeSerif; Courier → FreeMono) und RGB-Bilder (PNG oder JPEG, kein CMYK).';
