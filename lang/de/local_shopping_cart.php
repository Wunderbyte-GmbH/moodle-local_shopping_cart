...
$string['addresses:newaddress:updated'] = 'Addresse erfolgreich geändert';
...
$string['addresses:saveaddress:submit'] = 'Adresse speichern';
...
$string['addtocartitem'] = 'In den Warenkorb: {$a}';
...
$string['allowcustombookingfee'] = 'Artikelspezifische Buchungsgebühr erlauben';
$string['allowcustombookingfee_desc'] = 'Artikel (z. B. Buchungsoptionen) können in ihrem Einstellungsformular eine eigene Buchungsgebühr festlegen. Sie übersteuert die globale und die Kostenstellen-Buchungsgebühr; leer bedeutet, dass die globale Gebührenlogik gilt, 0 bedeutet ausdrücklich keine Gebühr. Bei mehreren Artikeln im Warenkorb wird die höchste artikelspezifische Gebühr eingehoben.';
...
$string['applydiscountitem'] = 'Rabatt für {$a} vergeben';
...
$string['cachedef_cachedcouponstable'] = 'Gutscheincode Cache';
...
$string['cartbadge'] = 'Warenkorb-Badge (einbettbar)';
$string['cartcheckout'] = 'Warenkorb-Checkout (einbettbar)';
$string['cartisempty'] = 'Ihr Warenkorb ist leer.';
$string['cartisfull'] = 'Ihr Warenkorb ist voll.';
$string['cartitemcount'] = '{$a} Artikel im Warenkorb';
$string['cash'] = 'Bargeld';
...
$string['checkvatnrnumber'] = "Geben Sie Ihre UID an";
...
$string['countmode'] = 'Nutzungen zählen pro';
$string['countmode_help'] = 'Checkout: Ein Checkout zählt als eine Nutzung, egal wie viele Artikel darin rabattiert wurden. Artikel: Jeder rabattierte Artikel zählt als eine Nutzung, ein Checkout mit vier rabattierten Artikeln verbraucht den Gutschein also viermal. Artikel, auf die der Gutschein nicht anwendbar ist, zählen nie.';
$string['countmodecheckout'] = 'Checkout';
$string['countmodeitem'] = 'Artikel';
...
$string['couponcodeexists'] = 'Ein Gutschein mit diesem Code existiert bereits.';
...
$string['couponmaxusesperuserreached'] = 'Sie haben diesen Gutscheincode bereits die maximale Anzahl an Malen verwendet.';
...
$string['decreaseamount'] = 'Anzahl von {$a} verringern';
...
$string['deleteitem'] = '{$a} aus dem Warenkorb entfernen';
...
$string['email'] = 'E-Mail';
$string['embedheading'] = 'Einbetten (iframe)';
$string['embedheadingdescription'] = 'Einstellungen für Warenkorb-Ansichten (Badge, Checkout), die per iframe auf externen Websites über den Embed-Endpoint eines Verkäufer-Plugins angezeigt werden.';
$string['embedredirectallowlist'] = 'Erlaubte Weiterleitungsziele';
...
$string['invalidabsolute'] = 'Der absolute Rabatt darf nicht negativ sein.';
$string['invalidcountmode'] = 'Ungültiger Zählmodus für Gutscheinnutzungen.';
$string['invalidcouponcode'] = 'Ungültiger Gutscheincode.';
$string['invalidmaxnumber'] = 'Die maximale Anzahl an Verwendungen darf nicht negativ sein. 0 bedeutet unbegrenzt.';
$string['invalidpercentage'] = 'Bitte geben Sie einen Wert zwischen 0 und 100 ein.';
...
$string['licenseheadingdescription'] = 'Einige Funktionen von Shopping Cart, wie z. B. Gutscheine, erfordern einen gültigen PRO-Lizenzschlüssel.';
$string['licenseinvalid'] = 'Der Lizenzschlüssel ist ungültig.';
$string['licensekey'] = 'Lizenzschlüssel';
$string['licensekeydesc'] = 'Geben Sie hier Ihren Shopping Cart PRO-Lizenzschlüssel ein, um PRO-Funktionen wie Gutscheine zu aktivieren.';
$string['licensewrongproduct'] = 'Dieser Lizenzschlüssel ist für Shopping Cart PRO nicht gültig.';
$string['lt'] = "Litauen";
$string['lu'] = "Luxemburg";
$string['lv'] = "Lettland";
...
$string['maxnumber'] = 'Maximale Anzahl an Verwendungen';
$string['maxnumber_help'] = 'Maximale Anzahl an Verwendungen über alle Nutzer:innen hinweg. 0 bedeutet unbegrenzt. Gezählt wird anhand des Ledgers gemäß dem Zählmodus.';
$string['maxnumberperuser'] = 'Maximale Anzahl an Verwendungen pro Nutzer:in';
$string['maxnumberperuser_help'] = 'Maximale Anzahl an Verwendungen für eine einzelne Person. 0 bedeutet unbegrenzt. Gezählt wird anhand des Ledgers gemäß dem Zählmodus.';
$string['modifyreservationtimeitem'] = 'Reservierungsdauer von {$a} ändern';
...
$string['nomulticurrencysupportyet'] = 'Guthaben in mehr als einer Währung wird noch nicht unterstützt. Bitte wenden Sie sich an die Administration der Website.';
...
$string['onlywithvatnrnumber'] = "UID ist verpflichtend";
$string['onlywithvatnrnumber_desc'] = "Buchen nur erlauben, wenn eine gültige UID hinterlegt ist.";
...
$string['owncountrycode_desc'] = "Land, in welchem die eigene Firma ansässig ist.";
...
$string['ownvatnrnumber'] = "UID der eigenen Firma";
$string['ownvatnrnumber_desc'] = "Umsatzsteuer-ID der eigenen Firma.";
$string['paid'] = 'Bezahlt';
...
$string['paymentfailed'] = 'Zahlung nicht erfolgreich';
$string['paymentfaileddescription'] = 'Etwas ist mir Ihrer Zahlung schief gelaufen. Bitte versuchen Sie es noch einmal.';
...
$string['paymentmethodpartialrefund'] = 'Teilrückerstattung';
...
$string['privacy:metadata:local_shopping_cart_guestusers'] = 'Erfasst temporäre Gast-Checkout-Benutzer, bis sie in ein dauerhaftes Konto umgewandelt oder gelöscht werden';
$string['privacy:metadata:local_shopping_cart_guestusers:timecreated'] = 'Zeitstempel, zu dem der Gast-Benutzer erstellt wurde';
$string['privacy:metadata:local_shopping_cart_guestusers:userid'] = 'Die ID des temporären Gast-Benutzers';
$string['privacyheading'] = "Privatsphäreneinstellungen";
$string['privacyheadingdescription'] = "Einstellungen in Verbindung mit den Moodle Privatsphäreneinstellungen";
...
$string['shopping_cart:canseecartnavitem'] = 'Kann Warenkorb-Navigationseinträge sehen';
...
$string['shopping_cart:editcoupons'] = 'Kann Gutscheine verwalten';
$string['shopping_cart:history'] = 'Verlauf (History) anzeigen';
$string['shoppingcarthistory'] = 'Alle bisherigen Käufe einer Person';
$string['shortcode_warning_invalid_securitytoken'] = 'Das Sicherheitstoken des Warenkorb-Shortcodes ist ungültig.';
$string['shortcode_warning_missing_securitytoken'] = 'Dieser Warenkorb-Shortcode benötigt einen securitytoken-Parameter.';
$string['shortcodeschistorysettings'] = 'Anzeige der Buchungshistorie (Shopping Cart History) anpassen';
$string['shortcodetoken'] = 'Sicherheitstoken für Shortcodes';
$string['shortcodetoken_desc'] = 'Sicherheitstoken für die einbettbaren Warenkorb-Shortcodes (cartbadge, cartcheckout). Standardmäßig wird ein zufälliges 8-stelliges Token erzeugt. Nur Shortcodes, die dasselbe Token im Parameter securitytoken übergeben, werden angezeigt.';
$string['showcart'] = 'Warenkorb anzeigen';
$string['showcartwithcount'] = 'Warenkorb anzeigen, {$a} Artikel';
...
$string['showwhereactive'] = 'Anzeigen, wo der Gutschein verwendet werden kann';
$string['si'] = "Slowenien";
$string['sk'] = "Slowakei";
...
$string['task:deleteguestuser'] = 'Lösche nicht umgewandelten Gast-Checkout-Benutzer Task';
...
$string['timeleft'] = 'Verbleibende Zeit im Warenkorb';
...
$string['tocheckout'] = 'Zur Bezahlung';
$string['tocheckoutitem'] = 'Zur Bezahlung, {$a} ist im Warenkorb';
$string['token'] = 'Token';
...
$string['usevatnr'] = "Umsatzsteuer-ID (UID) eingeben";
