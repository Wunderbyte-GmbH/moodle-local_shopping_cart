...
$item = new cartitem(1, 'Testitem 1', 10.00, 'EUR', 'local_shopping_cart', 'main', 'My Testitem 1 description', '', $canceluntil);
$data = $item->getitem();
$data = new button($data);
echo $renderer->render_button($data);
$item = new cartitem(2, 'asdsad 2', 20.3, 'EUR', 'local_shopping_cart', 'main', 'My Testitem 2 description', '', $canceluntil);
$data = $item->getitem();
$data = new button($data);
global $USER;
