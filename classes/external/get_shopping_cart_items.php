                ...
                'items' => new external_multiple_structure(
                    new external_single_structure(
                        [
                            ...
                            'taxpercentage_visual' => new external_value(
                                PARAM_FLOAT,
                                'Tax percentage of item price as an int',
                                VALUE_OPTIONAL
                            ),
                            ...
                            'canceluntil' => new external_value(
                                PARAM_INT,
                            ...
                            'coupondiscount' => new external_value(PARAM_FLOAT, 'Coupon discount applied to this item', VALUE_OPTIONAL),
                            'originalprice' => new external_value(PARAM_FLOAT, 'Original price before coupon discount', VALUE_OPTIONAL),
                        ]
                    )
                ),
            ]
