                        ...
                        'items' => new external_multiple_structure (
                                new external_single_structure(
                                        [
                                                ...
                                                'price_gross' => new external_value(PARAM_FLOAT, 'Gross price of item', VALUE_OPTIONAL),
                                                'price_net' => new external_value(PARAM_FLOAT, 'Net price of item', VALUE_OPTIONAL),
                                                'tax' => new external_value(PARAM_FLOAT, 'Net tax of item price', VALUE_OPTIONAL),
                                                'taxcategory' => new external_value(PARAM_TAG, 'Tax category of item', VALUE_OPTIONAL),
                                                'taxpercentage' => new external_value(PARAM_FLOAT,
                                                        'Tax percentage of item price as float', VALUE_OPTIONAL),
                                                ...
                                                'costcenter' => new external_value(PARAM_TEXT, 'Cost center for item', VALUE_OPTIONAL),
