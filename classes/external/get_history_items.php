        ...
        return new external_multiple_structure(
            new external_single_structure(
                [
                    ...
                    'timecreated' => new external_value(PARAM_TEXT, 'Time created', VALUE_DEFAULT, null),
                    'timemodified' => new external_value(PARAM_TEXT, 'Time modified', VALUE_DEFAULT, null),
                    'serviceperiodstart' => new external_value(PARAM_TEXT, 'Service period start', VALUE_DEFAULT, null),
                    'serviceperiodend' => new external_value(PARAM_TEXT, 'Service period end', VALUE_DEFAULT, null),
